    ...
    <section className="bg-primary text-on-primary py-xl">
      <div className="max-w-container-max mx-auto px-gutter">
        ...
        <div className="text-center mb-lg">
          ...
          <h2 className="font-display-lg text-display-lg-mobile md:text-display-lg text-on-primary mb-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-lg items-center mb-xl">
          {/* CEO Image */}
          <div className="relative h-[400px] sm:h-[480px] rounded-2xl overflow-hidden shadow-2xl group">
            <Image 
              src="/HVLee.png" 
          ...
          <div className="space-y-md">
            <div className="flex items-start gap-sm">
              <div className="w-12 h-12 rounded-xl bg-primary-fixed/20 flex items-center justify-center shrink-0">
                <span className="material-symbols-outlined text-primary-fixed text-[24px]">diversity_3</span>
              </div>
              <div>
                <h3 className="font-title-lg text-title-lg text-on-primary mb-xs">Locally Rooted, Globally Trusted</h3>
            ...
            <div className="flex items-start gap-sm">
              ...
              <div>
                <h3 className="font-title-lg text-title-lg text-on-primary mb-xs">Conservation at Our Core</h3>
                <p className="font-body-md text-body-md text-on-primary/80 leading-relaxed">
            ...
            <div className="flex items-start gap-sm">
              ...
              <div>
                <h3 className="font-title-lg text-title-lg text-on-primary mb-xs">Award-Winning Excellence</h3>
                <p className="font-body-md text-body-md text-on-primary/80 leading-relaxed">
        ...
        {/* Stats Bar */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-sm bg-primary-container/20 rounded-2xl p-md border border-primary-fixed/10 mb-lg">
          {[
            ...
            <div key={stat.label} className="text-center py-sm">
              <span className="material-symbols-outlined text-primary-fixed text-[28px] mb-xs block">
                {stat.icon}
              </span>
              <p className="font-headline-sm text-headline-sm text-on-primary">{stat.value}</p>
              <p className="font-label-sm text-label-sm text-on-primary/70 uppercase tracking-wider mt-xs">{stat.label}</p>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-sm">
          <div className="relative h-[300px] sm:h-[360px] rounded-2xl overflow-hidden shadow-xl group">
            <Image 
              src="/team-safari.jpg" 
            ...
            <div className="absolute bottom-md left-md right-md">
              ...
              <p className="font-body-sm text-body-sm text-white/80 mt-xs">
