export default function Philosophy() {
  return (
    <section className="max-w-container-max mx-auto px-gutter py-12 md:py-xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-xl items-center">
        <div>
          <h2 className="font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-3 md:mb-md">Our Philosophy</h2>
          <p className="font-body-lg text-body-lg text-on-surface-variant mb-4 md:mb-6 leading-relaxed">
          ...
          <button className="mt-6 md:mt-8 border-b-2 border-primary text-primary font-label-md text-label-md pb-1 hover:text-primary-container hover:border-primary-container transition-colors">
            Discover Our Impact
          </button>
        </div>
